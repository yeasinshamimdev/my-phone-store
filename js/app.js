...
const showAllCard = document.getElementById('show-all');
...
const card = (phone, div) => {
    ...
    <div class="card h-100 justify-content-center">
        ...
        <div class="card-body mx-auto text-dark">
            <h4 class="card-title phone-name">Name: ${phone.phone_name}</h4>
            <p class="card-text">Brand: <span class="badge bg-info text-dark">${phone.brand}</span></p>
        </div>
        <button onclick="loadDetails('${phone.slug}')" class="btn btn-primary w-50 mx-auto mb-2 btn-text-cus rounded-pill" data-bs-toggle="modal" data-bs-target="#exampleModal">More details</button>
    </div>
    `;
}
